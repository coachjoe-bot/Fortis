...
- Quick Log: the LOG button opens a sheet pre-filled with today's session for one-tap logging; typing the workout in chat logs it too. Logging is automatic either way.

...
// Native iOS shell detection + the self-hosted OTA bootstrap (App Store build,
// build plan §1/§3/§6). Both are no-ops on web/PWA — isNativeIOS() is false
// there, so every call site below is dormant outside the Capacitor iOS wrapper.
